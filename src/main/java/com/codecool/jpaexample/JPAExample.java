...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        phoneNumberList.add("+363535355553");
        phoneNumberList.add("+36384848");
        phoneNumberList2.add("+343434334343");
        phoneNumberList2.add("+3634343484848");
        phoneNumberList2.add("+34543343484848");
        ...
        Student student = new Student("Ödön", "odon@tokodon.hu", birthDate1, phoneNumberList, address);
        ...
        Student student2 = new Student("Aladár", "ktyfl@gmail.com", birthDate2, phoneNumberList2 ,address2);
        classBp2.addStudent(student2);
        student2.setPhoneNumbers("fdfd433435434354353");
